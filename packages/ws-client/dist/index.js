...
function getTests(suite) {
  return toArray$1(suite).flatMap((s) => isAtomTest(s) ? [s] : s.tasks.flatMap((c) => isAtomTest(c) ? [c] : getTests(c)));
}
...
function hasBenchmark(suite) {
  return toArray(suite).some((s) => {
    var _a;
    return (_a = s == null ? void 0 : s.tasks) == null ? void 0 : _a.some((c) => {
      var _a2;
      return ((_a2 = c.meta) == null ? void 0 : _a2.benchmark) || hasBenchmark(c);
    });
  });
}
