...
interface ResolvedTestEnvironment extends ContextTestEnvironment {
    name: VitestEnvironment;
    environment: Environment;
    options: EnvironmentOptions | null;
}
...
export { ContextRPC as $, AfterSuiteRunMeta as A, BaseCoverageOptions as B, CoverageOptions as C, BuiltinEnvironment as D, Environment as E, FakeTimerInstallOpts as F, VitestEnvironment as G, VitestPool as H, CSSModuleScopeStrategy as I, JSDOMOptions as J, ApiConfig as K, EnvironmentOptions as L, MockFactory as M, DepsOptimizationOptions as N, TransformModePatterns as O, ProjectConfig as P, InlineConfig as Q, ResolvedConfig as R, TypecheckConfig as S, TestSequencer as T, UserConfig as U, VitestRunMode as V, WorkspaceSpec as W, RuntimeRPC as X, RunnerRPC as Y, ContextTestEnvironment as Z, ResolvedTestEnvironment as _, CoverageProvider as a, WorkerContext as a0, ResolveIdFunction as a1, WorkerGlobalState as a2, Awaitable as a3, Nullable as a4, Arrayable as a5, ArgumentsType$1 as a6, MutableArray as a7, Constructable as a8, ModuleCache as a9, EnvironmentReturn as aa, OnServerRestartHandler as ab, ReportContext as ac, CoverageReporter as ad, CoverageIstanbulOptions as ae, CustomProviderOptions as af, BenchmarkUserOptions as ag, Benchmark as ah, BenchmarkResult as ai, BenchFunction as aj, CoverageProviderModule as b, ResolvedCoverageOptions as c, CoverageV8Options as d, Vitest as e, PendingSuiteMock as f, MockMap as g, WorkspaceProject as h, TestSequencerConstructor as i, BenchmarkAPI as j, MockFactoryWithHelper as k, RuntimeConfig as l, UserConsoleLog as m, ModuleGraphData as n, Reporter as o, globalExpect as p, createExpect as q, setupChaiConfig as r, startVitest as s, ChaiConfig as t, RawErrsMap as u, TscErrorInfo as v, CollectLineNumbers as w, CollectLines as x, RootAndTarget as y, Context as z };
